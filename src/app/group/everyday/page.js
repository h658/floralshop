        ...
        <>
            <div className="bg-pink-100 max-h-full pb-28">
                <div className="text-center text-pink-800 pt-9 space-y-3 italic">
                    <p className="font-light text-xl tracking-wider">"flowers bring the extraordinary into the ordinary,</p>
                    <Headline><p className="font-medium text-5xl tracking-wider ">Everyday.."</p> </Headline>
                </div>
                ...
                <div className="grid grid-cols-3 space-x-6 space-y-12 ml-16 mr-10">
                    ...
                    <ListItems Image={'/new.jpg'} Description={"Bright and cheerful, with large, distinctive blooms."} Price={'Rs.299/-'} />
                    <ListItems Image={'/items/pic5.jpg'} Description={" Graceful and elegant, symbolizing springtime blooms."} Price={'Rs.199/-'} />
